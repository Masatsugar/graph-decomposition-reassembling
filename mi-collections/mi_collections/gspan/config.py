...
parser.add_argument(
    "-s", "--min_support", type=int, default=5000, help="min support, default 5000"
)
parser.add_argument(
    "-n",
    "--num_graphs",
...
parser.add_argument(
    "-u",
    "--upper_bound_of_num_vertices",
    type=int,
    default=float("inf"),
    help="int, upper bound of number of vertices of output subgraph, " "default inf",
)
parser.add_argument(
    "-d",
    "--directed",
...
parser.add_argument("database_file_name", type=str, help="str, database file name")
parser.add_argument(
    "-p",
    "--plot",
    type=str2bool,
...
parser.add_argument(
    ...
    type=str2bool,
    default=False,
    help="bool, output where one frequent subgraph appears in database, " "default off",
)
